...
class AttendeesControllerTest < ActionController::TestCase
  ...
  test "should update attendee" do
    patch :update, id: @attendee, attendee: { address: @attendee.address, bio: @attendee.bio, name: @attendee.name, picture: @attendee.picture, twitter_handle: @attendee.twitter_handle }
    assert_redirected_to attendee_path(assigns(:attendee))
  end
